...
We encourage community members to use **GitHub Discussions** for open-ended questions, design discussions, and community sharing!
...
- Use **GitHub Issues** when you have encountered a verifiable bug or have a clear, scoped implementation task (like a Good First Issue).
- Use **GitHub Discussions** for brainstorming, open questions, or requesting feedback on plugin designs.
